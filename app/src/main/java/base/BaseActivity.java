...
import com.ysy15350.easyquick.MainActivity;
import com.ysy15350.easyquick.R;
import com.ysy15350.easyquick.StartActivity;
...
import static com.ysy15350.easyquick.R.id.ll_menu;
...
public class BaseActivity extends AppCompatActivity implements IView {
    ...
    public static AidlPrinter printDev = null;
    ...
    public void printTitle(String content) {
        ...
        try {
            if (!CommFunAndroid.isNullOrEmpty(content)) {
                ...
                list.add(new PrintDataObject(content, 8,
