package com.ysy15350.easyquick.broadcast;
...
public class MyReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        mVoice = VoiceBroadcast.getInstance(context);//语音合成初始化，此处是测试，在功能需要是初始化并调用
            ...
            if (!CommFunAndroid.isNullOrEmpty(extras)) {
                ...
                try {
                    ...
                    if (extras1 != null) {
                        ...
                        String print_content = extras1.getPrint_content();
                        if (!CommFunAndroid.isNullOrEmpty(print_content)) {

                            String title = extras1.getTitle();
                            ShangMiPrintHelper.print(title, print_content);

                            ShengTengHelper.getInstance().print(title, print_content);
                        }
