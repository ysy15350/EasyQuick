 ...
 * @author yangshiyou
 */
public class ListViewAdpater_PersonWater extends CommonAdapter<PersonWater> {


    public ListViewAdpater_PersonWater(Context context, List<PersonWater> list) {
        super(context, list, R.layout.list_item_person_water);


    }

    @Override
    public void convert(ViewHolder holder, PersonWater t) {
        if (t != null) {
            int type = t.getType();
            switch (type) {
                case 1://支付宝支付
