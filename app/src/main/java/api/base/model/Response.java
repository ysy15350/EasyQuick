...
//    订单
    ...
    public int getTx_total_price() {
        return tx_total_price;
    }

    public void setTx_total_price(int tx_total_price) {
        this.tx_total_price = tx_total_price;
    }
    ...
    public <T> T getData(Type type) {
        try {
            ...
            Log.d(TAG, "getData() called with: type = [" + type + "]");
            e.printStackTrace();
        }
