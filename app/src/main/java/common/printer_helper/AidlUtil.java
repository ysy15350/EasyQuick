...
import common.printer_helper.bean.TableItem;
...
public class AidlUtil {
    ...
    public void setDarkness(int index) {
        if (woyouService == null) {
            Toast.makeText(context, "打印机未就绪", Toast.LENGTH_LONG).show();
            return;
        }
    ...
    public void printText(String content, float size, boolean isBold, boolean isUnderLine,int lineWrap) {
        ...
        Log.d(TAG, "printText() called with: content = [" + content + "], size = [" + size + "], isBold = [" + isBold + "], isUnderLine = [" + isUnderLine + "]");
